    ...
    if($usuarioEncontrado == null){
      $errores["email"]="El usuario no existe en nuestra base de datos";
        ...
        $registro = $json->jsonRegistroOlvide($usuario->getEmail(),$usuario->getPassword());
          redirect("cambioContrasenia.php");
    }
  }
}
?>
  ...
  <div class="container">
    ...
    <section class="row text-center">
      <article class="col-8 col-md-6 col-xl-6" >
          <h2 class="__titulo">Recuperá tu Contraseña</h2>
          <form action="" method="POST" enctype= "multipart/form-data"  >
            <input class="__campos" name="email" type="text" id="email" value="<?=isset($errores["email"])? "":inputUsuario("email") ;?>" placeholder="Correo electrónico"/>
            <br>
            <input class="__campos" name="password" type="password" id="password" value="" placeholder="Nueva Contraseña." />
            <br>
            <input class="__campos" name="repassword" type="password" id="repassword" value="" placeholder="Confirmar Nueva Contraseña" />
            <br>
            <br>
            <button class="__login" type="submit">Enviar</button>
          </form>
