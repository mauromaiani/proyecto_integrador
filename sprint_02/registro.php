  ...
  <body>
    ...
    <div class="formulario">s
      <?php
       ...
       <div class="inpts">
          <input class="inp" name="nombre" type="text" id="nombre"  value="" placeholder="Nombre">
         <input class="inp" name="email" type="email" id="email" value="" placeholder="Correo electronico">
         <input class="inp" type="password" id="password" name="password" value="" placeholder="password">
         <input class="inp" type="password" id="repassword" name="repassword" value="" placeholder="Repetir pasword">
       </div>
       <div class="btns">
