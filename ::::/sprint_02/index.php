    ...
    <header>
      ...
      <section class="row align-items-center __juntos">
          <article class="__textos text-md-right text-center col-xs-12 col-md-5 col-lg-4">
            ...
            <button type="button" class="__registrarse" data-toggle="modal" data-target="#exampleModal">
              registrate
            </button>
...
<!--empieza LOGIN ---->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="">
          <div>
            <input class="__campos" type="text" name="usuario" value="" placeholder="Usuario">
            <input class="__campos" type="password" name="contraseña" value="" placeholder="Contraseña">
          </div>
          <div class="text-center">
            <label class="__texto"><input type="checkbox" name="recordarme">Recordarme</label>
            <br>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="__login">Entrar</button>
      </div>
    </div>
    </div>
    </div>
